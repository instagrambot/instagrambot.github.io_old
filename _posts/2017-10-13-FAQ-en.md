...
[Installation for Windows](/2017/10/13/Installation-on-Windows-en.html). 
[Installation for Unix](/2017/10/13/Installation-on-Unix-en.html) (Linux, MacOS).
...
There is. Thanks to the efforts of our community, a very cool script was written. You can find it under the name [multi_script_CLI.py](https://github.com/instagrambot/instabot/examples/multi_script_CLI.py). He is in English, but I think everything will be clear. I strongly advise you to try it!

### How can I organize an auto-posting photo in the Instagram?

For this, we have a daddy in [examples](https://github.com/instagrambot/instabot/examples/autopost). Below on that page you will find how to configure and run auto-hosting.
